...
class HPE(nn.Module):
    def __init__(self, in_channels, mode=4, norm_args=None, act_args=None):
    ...
    def forward(self, xyz):
        ...
        if self.mode == 1:
            ...
            position_embedding = position_embedding.reshape(B, (C // 6) * 6, npoint,
                                                            k).contiguous()  # (B, 3*C, npoint, k)
